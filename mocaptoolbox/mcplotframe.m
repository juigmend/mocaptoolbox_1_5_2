...
if isfield(p, 'folder') % BB20150303/20150717 % pragma removed (JIMG 2021/2/4)
    p.output=p.folder;
    p = rmfield(p,'folder');
...
if ~isfield(p, 'child') % (JIMG 2022/12/4)
    p.child = 0;
end
...
if isfield(p,'frameformat') == 0        % (JIMG 2020/7/9)
    p.frameformat = 'png';              % (JIMG 2020/7/9)
end                                     % (JIMG 2020/7/9)
if strcmp(p.frameformat,'fig')          % (JIMG 2020/7/9)
    fext = '.fig';                      % (JIMG 2020/7/9)
elseif strcmp(p.frameformat,'tiff')     % (JIMG 2020/7/9)
    fext = '.tif';                      % (JIMG 2020/7/9)
else                                    % (JIMG 2020/7/9)
    fext = ['.',p.frameformat];         % (JIMG 2020/7/9)
end                                     % (JIMG 2020/7/9)
...
%             saveas(gcf, fn, 'eps');
    ...
    elseif ~isempty(p.output)                                              % (JIMG 2022/12/5)
        ...
        if strcmp(p.frameformat,'fig') || strcmp(p.frameformat,'tiff')     % (JIMG 2020/7/9)
            ...
            if strcmp(p.frameformat,'fig')                                 % (JIMG 2020/7/9)
                savefig(figh,fn)                                           % (JIMG 2020/7/9)
            elseif strcmp(p.frameformat,'tiff')                            % (JIMG 2020/7/9)
                figh.PaperPositionMode = 'auto';                           % (JIMG 2020/7/9)
                print(figh,fn,'-dtiff','-r300')                            % (JIMG 2020/7/9)
            end
        else                                                               % (JIMG 2020/7/9)
            imwrite(frame2im(getframe),fn,p.frameformat);                  % (JIMG 2020/7/9)
        end                                                                % (JIMG 2020/7/9)
    end
end
